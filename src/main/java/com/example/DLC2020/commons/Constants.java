...
public class Constants {
	public final static String DELIMS = "([^a-zA-Z']+)'*\\1*"; // "[ .,?!--;://_@!¡«»?¿0-9=°ªï»¿~<>]+";

	public final static List<String> STOP_WORDS = Arrays.asList("", "a", "a's", "able", "about", "above", "according",
			...
			"didn't", "different", "do", "does", "doesn't", "doing", "don", "don't", "done", "down", "downwards",
			...
			"sup", "sure", "t", "t's", "take", "taken", "tell", "tends", "th", "than", "thank", "thanks", "thanx",
			...
			"usually", "value", "various", "very", "via", "viz", "vs", "want", "wants", "was", "wasn't", "way", "we",
